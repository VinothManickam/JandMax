                ...
                <div className="footer max-w-full mx-auto px-4 sm:px-6 bg-gray-100 border-t border-b py-30">
                    ...
                    <div className="col-span-12 lg:col-span-4">
                        <div className="box-border border-b-4 border-blue-900 p-8 bg-gray-200 text-gray-600 text-center rounded-lg xl:w-80 mx-auto">
                            <h3 className="font-bold text-4xl mb-4">J @ M Tax</h3>
                            <div className='text-md font-medium text-gray-600'>
                                <h5>3707 Irving Place, Arnold, MO 63010</h5>
                                <p>(647)877-8637,</p>
                                <p>jandmtaxsolutions@gmail.com,</p>
                                <p>Canada.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="col-span-6 md:col-span-6 lg:col-span-4 mx-auto">
                        ...
                        <ul className="text-md">
                        <li className="mb-2">
                            <Link to="#" className="text-[#013289] hover:text-gray-900 hover:tracking-wider transition duration-250 ease-in-out">Personal Taxes</Link>
                        </li>
                        <li className="mb-2">
                            <Link to="#" className="text-[#013289] hover:text-gray-900 hover:tracking-wider transition duration-250 ease-in-out">Corporate Taxes</Link>
                        </li>
                        <li className="mb-2">
                            <Link to="#" className="text-[#013289] hover:text-gray-900 hover:tracking-wider transition duration-250 ease-in-out">Book Keeping</Link>
                        </li>
                        <li className="mb-2">
                            <Link to="#" className="text-[#013289] hover:text-gray-900 hover:tracking-wider transition duration-250 ease-in-out">Accounting</Link>
                        </li>
                        </ul>
                    </div>
